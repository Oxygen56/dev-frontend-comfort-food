...
The suite checks both entries in Chromium, including automated accessibility scans, 320 px reflow, keyboard interaction, reduced-motion behavior, no-JavaScript fallback, and local-only assets.
